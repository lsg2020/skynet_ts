...
import Readable, { ReadableState } from "./readable";
import Stream from "./stream";
import Writable, { WritableState } from "./writable";
...
import createReadableStreamAsyncIterator from "./async_iterator";
import type { ReadableStreamAsyncIterator } from "./async_iterator";
import {
  _destroy,
...
} from "./readable_internal";
import { kOnFinished, writeV } from "./writable_internal";
import {
  endDuplex,
  finishMaybe,
  onwrite,
  readableAddChunk,
} from "./duplex_internal";
export { errorOrDestroy } from "./duplex_internal";
