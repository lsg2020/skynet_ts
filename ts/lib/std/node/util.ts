...
import { promisify } from "./_util/_util_promisify";
import { callbackify } from "./_util/_util_callbackify";
import { ERR_INVALID_ARG_TYPE, ERR_OUT_OF_RANGE, errorMap } from "./_errors";
import * as types from "./_util/_util_types";
...
import { _TextDecoder, _TextEncoder } from "./_utils";

/** The global TextDecoder */
export type TextDecoder = import("./_utils")._TextDecoder;
export const TextDecoder = _TextDecoder;

/** The global TextEncoder */
export type TextEncoder = import("./_utils")._TextEncoder;
