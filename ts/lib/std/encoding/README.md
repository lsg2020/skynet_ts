...
```ts
import { parse } from "https://deno.land/std@$STD_VERSION/encoding/csv";
const string = "a,b,c\nd,e,f";
...
import {
  parse,
  stringify,
} from "https://deno.land/std@$STD_VERSION/encoding/yaml";
...
```ts
import { parseAll } from "https://deno.land/std@$STD_VERSION/encoding/yaml";
...
import {
  decode,
  encode,
} from "https://deno.land/std@$STD_VERSION/encoding/base32";
...
import {
  decode,
  encode,
} from "https://deno.land/std@$STD_VERSION/encoding/ascii85";
