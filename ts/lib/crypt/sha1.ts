...
export module sha1
{
    ...
    function _hash(bufferOrString: any): [number, number, number, number, number] {
    ...
    export function str(bufferOrString: any): string
    {
        let [h0, h1, h2, h3, h4] = _hash(bufferOrString);
        return hex(h0) + hex(h1) + hex(h2) + hex(h3) + hex(h4);
    }

    export function array(bufferOrString: any): Uint8Array
    {
        let [h0, h1, h2, h3, h4] = _hash(bufferOrString);
